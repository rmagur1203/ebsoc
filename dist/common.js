...
function member(token) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "https://" + path_json_1.default.host + path_json_1.default.common.member;
    ...
    info: function (token, schoolCode) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "https://" + path_json_1.default.host + path_json_1.default.common.school.info.substitute({ schoolCode: schoolCode });
                        return [4 /*yield*/, axios_1.default({
                                method: 'GET',
                                url: url,
                                headers: {
            ...
            $subLessonSeq: function (token, path) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                url = "https://" + path_json_1.default.host + path_json_1.default.common.lecture.detail.lesson.$subLessonSeq
